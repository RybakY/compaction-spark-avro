...
object Compact extends App {
  ...
  override def main(args: Array[String]): Unit = {
    ...
    val file1 = "hdfs://localhost:8020/topics/scala_confluent/year=2020/month=08/day=11/hour=01/scala_confluent+0+0031828531+0031832242.avro"
    val f1Path = new Path(file1)
    val file2 = "hdfs://localhost:8020/topics/scala_confluent/year=2020/month=08/day=11/hour=01/scala_confluent+0+0031832243+0031858690.avro"
